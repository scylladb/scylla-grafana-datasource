...
var grafanaURL = function (repo) { return "https://api.github.com/repos/grafana/" + repo; };
...
var GithubClient = /** @class */ (function () {
    function GithubClient(_a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.required, required = _c === void 0 ? false : _c, _d = _b.enterprise, enterprise = _d === void 0 ? false : _d, _e = _b.repo, repo = _e === void 0 ? 'grafana' : _e;
