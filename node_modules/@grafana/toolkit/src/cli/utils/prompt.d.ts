...
export declare const promptList: <A>(name: string, message: string | ((answers: A) => string), choices: () => ChoiceOptions<import("inquirer").Answers>[], def?: any, when?: boolean | ((answers: A) => boolean | Promise<boolean>)) => ListQuestion<A>;
